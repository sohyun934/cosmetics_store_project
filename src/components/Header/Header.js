...
function Header() {
    ...
    return ((0, jsx_runtime_1.jsxs)("header", Object.assign({ className: toggle ? "header side-active" : "header" }, { children: [(0, jsx_runtime_1.jsx)(LeftGnb, {}), (0, jsx_runtime_1.jsx)(SideGnbBtn, { activeSideGnb: () => setToggle(!toggle) }), (0, jsx_runtime_1.jsx)(SideGnb, { logInOut: logInOut, logOut: e => logOut(e) }), (0, jsx_runtime_1.jsx)("div", Object.assign({ className: "logo" }, { children: (0, jsx_runtime_1.jsx)(react_router_dom_1.Link, Object.assign({ to: "/" }, { children: (0, jsx_runtime_1.jsx)("img", { src: require("../../assets/common/logo.png"), alt: "\uB85C\uACE0" }) })) })), (0, jsx_runtime_1.jsx)(RightGnb, { logOutDisplay: logInOut === "로그인" ? "none" : "block", logOut: e => logOut(e) })] })));
}
