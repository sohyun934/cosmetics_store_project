...
function Main() {
    ...
    function fetchUser() {
        return __awaiter(this, void 0, void 0, function* () {
            const q = (0, firestore_1.query)((0, firestore_1.collection)(firebase_1.default, "users"), (0, firestore_1.where)("name", "==", name), (0, firestore_1.where)("email", "==", email));
