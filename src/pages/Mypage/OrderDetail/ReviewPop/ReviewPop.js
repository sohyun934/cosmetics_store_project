...
function ReviewPop(props) {
    ...
    for (let i = 0; i < 5; i++) {
        lis.push((0, jsx_runtime_1.jsx)("li", Object.assign({ value: 5 - i, className: mode === "update" && 5 - i === rate ? "on" : "", onClick: () => setRate(5 - i) }, { children: (0, jsx_runtime_1.jsx)("button", { type: "button", onClick: handleRate }) }), i));
    }
