...
function Form() {
    ...
    const { register, handleSubmit, formState: { errors, isValid }, getValues, reset } = (0, react_hook_form_1.useForm)({ mode: "onChange" });
    ...
    const [userPw, setUserPw] = (0, react_1.useState)(state.password);
    ...
    const onSubmit = (data) => __awaiter(this, void 0, void 0, function* () {
        ...
        if (user) {
            ...
            (0, auth_1.reauthenticateWithCredential)(user, credential).then(() => {
                ...
                (0, auth_1.updatePassword)(user, updatePw);
                setUserPw(updatePw);
            });
            // 회원정보 업데이트
            const q = (0, firestore_1.query)((0, firestore_1.collection)(firebase_1.db, "users"), (0, firestore_1.where)("email", "==", user.email));
            ...
            (0, auth_1.reauthenticateWithCredential)(user, credential).then(() => {
                if (window.confirm("정말 탈퇴하시겠습니까?")) {
                    ...
                    (0, auth_1.deleteUser)(user)
                        ...
                        const querySnapshot = yield (0, firestore_1.getDocs)(q);
                        querySnapshot.forEach((document) => __awaiter(this, void 0, void 0, function* () {
                            yield (0, firestore_1.deleteDoc)((0, firestore_1.doc)(firebase_1.db, "users", document.id));
                        }));
